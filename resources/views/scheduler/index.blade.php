        ...
        <div class="row">
            <div class="col-12  d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-center align-items-center bg-light shadow-sm ">
                    <form action="{{ route('schedular.preMonth', date_format(current($monthArr), 'Y-M-d') ) }}" method="GET"
                         id="nextMonth">
                    ...
                    <form action="{{ route('schedular.nextMonth', date_format(end($monthArr), 'Y-M-d') ) }}" method="GET"
                         id="nextMonth">
    ...
    <div class="row  px-3 row">
        <div class="col-2 mb-2 position-relative">
            <div style="width: auto">
                <a class="btn btn-light w-100 dropdown-toggle" href="#" role="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" role="button"
            ...
            <ul class="dropdown-menu room-dropdown " style="width:100%;" aria-labelledby="dropdownMenuButton1">
                <li class="w-100">
                    <a href="{{route('schdeuler.index')}}" class="link btn btn-light w-100"><p>All room</p></a>
                </li>
