                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Payments by <span class="fw-bold">{{ $selectedStudent->name }}</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class=" table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr onclick="showPayments({{ $payment->classitem_id }}, {{ $payment->student_id }})" class="history" data-className="{{$payment->classitem->name}}" data-studentName="{{$payment->student->name}}" data-bs-toggle="modal" data-bs-target="#exampleModelOne">
...
@push('scripts')
    <!-- Modal -->
    <div class="modal fade hide" id="exampleModelOne" tabindex="-1" aria-labelledby="exampleModelOneLabel" aria-hidden="true">
