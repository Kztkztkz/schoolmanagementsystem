                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="--:--" onfocus="(this.type='time')" class="form-control"
                                    id="starttime">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-3">
                        ...
                        <div class="col-sm-4 mt-3">
                            <div class="form-group">
                                ...
                                <div class="multisel-day">
                                    <select class="js-example-basic-multiple form-select" name="days[]" multiple="multiple"
                                        id="day">
